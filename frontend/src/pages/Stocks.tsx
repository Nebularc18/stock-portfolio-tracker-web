...
/**
 * Produce a date string formatted for HTML date inputs (YYYY-MM-DD).
 *
 * @param value - The Date to format; defaults to the current date
 * @returns A string in `YYYY-MM-DD` representing the provided date
 */
...
/**
 * Create a new blank PositionEntry initialized for adding or editing a lot.
 *
 * @returns A PositionEntry with a generated `id`, `quantity` set to 0, and `purchase_price`, `purchase_date`, and `sell_date` set to `null`.
 */
