...
/**
 * Render the Analytics page showing portfolio and sector distributions as pie charts.
 *
 * Displays loading, error (with a retry action), and empty-data states; chart slice labels below 5% are hidden and tooltip values are formatted using the current display currency.
 *
 * @returns A React element containing the analytics UI (charts, or loading/error/empty states)
 */
